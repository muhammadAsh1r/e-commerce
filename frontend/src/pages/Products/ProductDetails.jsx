      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            <div className="relative aspect-square bg-white rounded-[3rem] overflow-hidden border border-gray-100 shadow-sm group">
              <img 
              ...
              <div className="absolute top-1/2 -translate-y-1/2 inset-x-4 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity">
                <button 
                  ...
                  className="p-3 bg-white/90 backdrop-blur-sm text-gray-900 rounded-2xl shadow-xl hover:bg-brand hover:text-white transition-all cursor-pointer"
                >
                  <ChevronLeft size={24} />
                </button>
                <button 
          ...
          <div className="flex flex-col">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl">{product.description}</p>
            </div>

            <div className="mb-10">
              <div className="flex items-baseline gap-4 mb-2">
                <span className="text-5xl font-black text-gray-900">{formattedPrice}</span>
                {product.oldPrice && (
                  <span className="text-2xl text-gray-400 line-through font-bold">PKR {product.oldPrice}</span>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              ...
              <div className="flex items-center gap-4 p-5 bg-white rounded-3xl border border-gray-100 shadow-sm">
                ...
                <div>
                  <p className="font-bold text-gray-900">Original Item</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              <div className="flex items-center bg-white border border-gray-200 rounded-[1.5rem] p-1.5 shadow-sm">
                <button 
                  onClick={() => setQuantity(prev => Math.max(1, prev - 1))}
                  className="p-3 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-xl transition-all cursor-pointer"
                >
                  <Minus size={20} />
                </button>
        ...
        <div className="mt-20">
          <div className="border-b border-gray-200 flex gap-10 mb-10">
            <button className="pb-4 text-lg font-black text-brand border-b-4 border-brand cursor-pointer">Description</button>
            <button className="pb-4 text-lg font-bold text-gray-400 hover:text-gray-600 transition-colors cursor-pointer">Specifications</button>
            <button className="pb-4 text-lg font-bold text-gray-400 hover:text-gray-600 transition-colors cursor-pointer">Reviews (120)</button>
          </div>
          <div className="max-w-4xl">
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              {product.description}
            </p>
            <div className="p-10 bg-white rounded-[3rem] border border-gray-100 shadow-sm flex items-center justify-between">
              <div>
                <h4 className="text-2xl font-black text-gray-900 mb-2">Need Help?</h4>
                <p className="text-gray-500 font-medium">Contact our premium support 24/7 for any queries regarding this product.</p>
              </div>
