          ...
          {isLoading ? (
            [...Array(4)].map((_, i) => (
              <div key={i} className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm animate-pulse">
                ...
                <div className="w-24 h-3 bg-gray-50 rounded-full mb-3" />
                      ...
                      <tr key={i} className="border-b border-gray-50 animate-pulse">
                        <td className="px-8 py-5 flex items-center gap-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="w-12 h-2 bg-gray-50 rounded-full" />
                          </div>
                        </td>
                        <td className="px-8 py-5"><div className="w-16 h-4 bg-gray-50 rounded-full" /></td>
                        <td className="px-8 py-5"><div className="w-24 h-4 bg-gray-50 rounded-full" /></td>
                      </tr>
                    ))
                  ) : (
